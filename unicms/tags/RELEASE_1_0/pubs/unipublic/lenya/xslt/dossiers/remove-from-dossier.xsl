...
<xsl:template match="/">
  <page:page>
    <page:title>Remove Article from Dossier</page:title>
    <page:body>
      <div class="lenya-box">
        <div class="lenya-box-title">Remove Article from Dossier</div>
        <div class="lenya-box-body">
          <form method="get" action="{$requestUri}">
            <input type="hidden" name="lenya.usecase" value="removefromdossier"/>
