          ...
          <table border="0" cellpadding="0" cellspacing="0" width="585" bordercolor="red">
            <tr>
              ...
              <td width="315" valign="top">
                ...
                <div bxe_xpath="/up:homepage" class="headlines">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td align="right" width="153" bgcolor="#CCCC99" valign="bottom">
          <xsl:apply-templates select="content/up:homepage/col:document[1]/up:teaser" mode="front"/>
        </td>
        <td width="3" bgcolor="#CCCC99"><img height="1" width="1" src="{$imageprefix}/1.gif"/></td>
        <td align="right" width="153" bgcolor="#CCCC99" valign="bottom">
          <xsl:apply-templates select="content/up:homepage/col:document[2]/up:teaser" mode="front"/>
        </td>
      ...
      <tr>
        ...
        <td width="153" valign="top" bgcolor="white" >
          <table cellspacing="0" cellpadding="3" border="0" bordercolor="green">
            <tr>
              <td class="tsr-text">
                <xsl:apply-templates select="content/up:homepage/col:document[1]" mode="top"/>
              </td>
            </tr>
          </table>
        </td>
        ...
        <td width="153" valign="top" bgcolor="white" >
          <table cellspacing="0" cellpadding="3" border="0" bordercolor="green">
            <tr>
              <td class="tsr-text">
                <xsl:apply-templates select="content/up:homepage/col:document[2]" mode="top"/>
              </td>
            </tr>
          </table>
        </td>
