...
<!-- $Id: dossiersbox-standard.xsl,v 1.6 2004/12/22 13:54:12 thomas Exp $ -->
...
<xsl:stylesheet version="1.0"
  ...
  exclude-result-prefixes="xhtml lenya dc service webperls"
  >
          ...
          <table border="0" cellpadding="0" cellspacing="0" width="585" bordercolor="red">
            <tr>
              <td id="navigation" align="right" valign="top" width="135">
                ...
                <xsl:apply-templates select="content/up:dossiersbox"/>
              </td>
