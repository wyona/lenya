...
<!--
 $Id: deactivate.xsl,v 1.1 2004/12/23 18:34:31 edith Exp $
 -->
        ...
        <div class="lenya-box-body">
          ...
          <table class="lenya-table-noborder">
            ...
            <tr>
              ...
              <td>
                <input type="radio" name="task-id" value="deactivate" checked="checked"/> Single document
                <br/>
                <input type="radio" name="task-id" value="deactivatetree"/> Subtree
              </td>
            </tr>
      ...
      <div class="lenya-box">
        ...
        <div class="lenya-box-body">
          ...
          <table class="lenya-table-noborder">
            ...
            <xsl:if test="message[@id='children-live']">
              <tr>
                <td valign="top" class="lenya-entry-caption">Scope:</td>
                <td>
                  <input type="radio" name="task-id" value="deactivate" disabled="disabled"/> Single document
                  <br/>
                  <input type="radio" name="task-id" value="deactivatetree" checked="checked"/> Subtree
                </td>
              </tr>
              <tr>
                <td valign="top" class="lenya-entry-caption">Info:</td>
                <td>
                  The single document cannot be deactivated
                  unless the following child documents are deactivated:
                  <ul>
            ...
            <xsl:if test="message[@id='not-check-out']">
              <tr>
                <td valign="top" class="lenya-entry-caption">Info:</td>
                <td>
                  The document cannot be deactivated because the document
                  <ul>
