...
<!-- $Id: asset.xsl,v 1.2 2005/01/18 13:17:29 edith Exp $ -->
      ...
      <!-- some values appear twice, this is required for roundtripping. -->
          ...
          <table class="lenya-table-noborder">
            ...
            <xsl:if test="$insertimage = 'true'">
              <tr>
                <td class="lenya-form-caption"><i18n:text>Caption</i18n:text>:</td><td><textarea class="lenya-form-element" name="properties.insert.asset.caption" rows="3">&#160;</textarea></td>
              </tr>
              <tr>
