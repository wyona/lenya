      ...
      <div class="contcol2">
        ...
        <div class="contentarea">
          ...
          <div class="content">
            <h1>
              <xsl:choose>
                <xsl:when test="/xhtml:document/xhtml:content/*/@title">
                  <xsl:value-of select="/xhtml:document/xhtml:content/*/@title"/>
                </xsl:when>
                <xsl:otherwise>
                  <xsl:value-of select="/xhtml:document/xhtml:content/*/lenya:meta/dc:title"/>
                </xsl:otherwise>
              </xsl:choose>
            </h1>
            <div>
             <xsl:apply-templates select="/xhtml:document/xhtml:content/*/*[not(self::lenya:meta)]"/> 
            </div>
          </div>
