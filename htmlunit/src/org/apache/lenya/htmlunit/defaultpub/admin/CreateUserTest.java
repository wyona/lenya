 ...
 */
package org.apache.lenya.htmlunit.defaultpub.admin;
...
public class CreateUserTest extends LenyaTestCase {
    ...
    public void createNewUser(String userid, String name, String email,
        ...
        loadHtmlPage(this.pubid + "/" + ADMIN_AREA + "/index.html?lenya.usecase=admin.users");
        ...
        HtmlSubmitInput button = (HtmlSubmitInput) form
                .getInputByValue(this.config.getString("lenya.tests.admin.users.buttonText"));
