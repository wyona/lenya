...
public class CreateTestFolder extends LenyaTestCase {
	
	private static final String TEST_NAME="DMS Folder testing";
    ...
    public static Test suite() {
        return new TestSuite(CreateTestFolder.class);
    }
