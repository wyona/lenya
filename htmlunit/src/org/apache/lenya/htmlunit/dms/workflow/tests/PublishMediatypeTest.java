...
public class PublishMediatypeTest extends LenyaTestCase {

	private static final String TEST_NAME = "DMS Publish Mediafolder testing";
	 ...
	 * @throws Exception
	 */
	public void testPublishMediatype() throws Exception {
        String newId = createTestNodeID();
        String verifyString= this.config.getString("lenya.tests.site.create.mediaType.testName");
        //setup helper
...
//      create a new media type 
        ...
        helper.doPublish(startDocID,verifyString);
	...
	public static Test suite() {
		return new TestSuite(PublishMediatypeTest.class);
	}
}
