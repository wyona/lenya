...
public class CreateWordDocument extends Create {
    ...
    protected void addDOC(Document document, ResourceType resourceType) throws Exception {
        ...
        try {
            ...
            String extension = DOC_EXTENSION.substring(1);
